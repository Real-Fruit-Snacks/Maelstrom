"""Main entry point for maelstrom.

This module orchestrates the Maelstrom enumeration workflow:
...
def run_kerberoast_spray(args, targets: list[str]) -> int:
    ...
    if not args.no_preauth_targets:
        ...
        print(
            "Usage: maelstrom target -u asrep_user -p '' "
...
def main():
    ...
    if args.json_output and not args.output:
        ...
        print("Usage: maelstrom <target> ... --json -o results.json")
        sys.exit(1)
