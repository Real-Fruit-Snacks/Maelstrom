...
from maelstrom.parsing.classify import (  # noqa: E402
    classify_groups,
    classify_users,
    is_builtin_account,
    is_computer_account,
...
from maelstrom.parsing.nxc_output import (  # noqa: E402
    extract_after_port,
...
class TestModuleArguments(unittest.TestCase):
    ...
    def setUp(self):
        ...
        from maelstrom.cli.args import create_parser
...
class TestCustomQueryParsing(unittest.TestCase):
    ...
    def setUp(self):
        ...
        from maelstrom.enums.custom_query import _parse_query_output
...
class TestRunNxcPortParameter(unittest.TestCase):
    ...
    def test_run_nxc_adds_port_to_command(self):
        ...
        with patch("maelstrom.core.runner.subprocess.run") as mock_run:
            ...
            from maelstrom.core.runner import run_nxc
...
class TestCheckPortIPv6(unittest.TestCase):
    ...
    def test_check_port_uses_af_inet_by_default(self):
        ...
        with patch("maelstrom.core.runner.socket.socket") as mock_socket_class:
            mock_socket = MagicMock()
            mock_socket.connect_ex.return_value = 0
            mock_socket_class.return_value = mock_socket

            from maelstrom.core.runner import check_port
...
class TestEnumCacheGetDnsArgs(unittest.TestCase):
    ...
    def test_get_dns_args_empty_when_no_options(self):
        ...
        from maelstrom.models.cache import EnumCache
...
class TestEnumCacheRunNxcCached(unittest.TestCase):
    ...
    def test_run_nxc_cached_applies_port(self):
        ...
        with patch("maelstrom.models.cache.run_nxc") as mock_run_nxc:
