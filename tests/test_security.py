"""Security-focused tests for Maelstrom.
...
from maelstrom.core.output import _REDACTED, _sanitize_cmd_args  # noqa: E402
from maelstrom.models.credential import Credential, CredentialError  # noqa: E402
from maelstrom.parsing.credentials import _check_file_permissions  # noqa: E402
...
class TestExternalToolAuth(unittest.TestCase):
    ...
    def test_password_auth_impacket(self):
        ...
        from maelstrom.reporting.next_steps import get_external_tool_auth
