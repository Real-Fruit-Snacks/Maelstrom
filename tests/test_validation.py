...
from maelstrom.models.credential import Credential  # noqa: E402
from maelstrom.validation.multi import _test_single_cred, validate_credentials_multi  # noqa: E402
...
class TestSprayControlOptions(unittest.TestCase):
    ...
    @patch("maelstrom.validation.multi._test_single_cred")
    @patch("maelstrom.validation.multi.print_section")
    @patch("maelstrom.validation.multi.status")
    @patch("maelstrom.validation.multi.output")
    ...
    @patch("maelstrom.validation.multi.time.sleep")
    @patch("maelstrom.validation.multi._test_single_cred")
    @patch("maelstrom.validation.multi.print_section")
    @patch("maelstrom.validation.multi.status")
    @patch("maelstrom.validation.multi.output")
...
class TestCredentialTestFunction(unittest.TestCase):
    ...
    @patch("maelstrom.validation.multi.run_nxc")
