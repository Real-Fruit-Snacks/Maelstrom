...
from maelstrom.models.cache import EnumCache  # noqa: E402
...
class TestActiveUsersFilter(unittest.TestCase):
    ...
    @patch("maelstrom.enums.users.run_nxc")
    @patch("maelstrom.enums.users.print_section")
    @patch("maelstrom.enums.users.status")
    @patch("maelstrom.enums.users.output")
    def test_active_users_filter_removes_disabled(
        ...
        from maelstrom.enums.users import enum_users
...
class TestSharesFilter(unittest.TestCase):
    ...
    @patch("maelstrom.enums.shares.run_nxc")
    @patch("maelstrom.enums.shares.print_section")
    @patch("maelstrom.enums.shares.status")
    @patch("maelstrom.enums.shares.output")
    def test_read_filter_only_shows_readable(
        self, mock_output, mock_status, mock_print_section, mock_run_nxc
    ):
        """Test --shares-filter READ only shows shares with READ access."""
        from maelstrom.enums.shares import enum_shares
...
class TestLocalGroupsFilter(unittest.TestCase):
    ...
    @patch("maelstrom.enums.local_groups.run_nxc")
    @patch("maelstrom.enums.local_groups.print_section")
    @patch("maelstrom.enums.local_groups.status")
    @patch("maelstrom.enums.local_groups.output")
    def test_filter_matches_group_case_insensitive(
        self, mock_output, mock_status, mock_print_section, mock_run_nxc
    ):
        """Test filter matches group name case-insensitively."""
        from maelstrom.enums.local_groups import enum_local_groups
...
class TestFilteredOutputIntegration(unittest.TestCase):
    ...
    def test_json_output_with_share_filter(self):
        ...
        from maelstrom.core.output import JSON_DATA
        from maelstrom.enums.shares import enum_shares
        ...
        with (
            patch("maelstrom.enums.shares.run_nxc") as mock_run_nxc,
            patch("maelstrom.enums.shares.print_section"),
            patch("maelstrom.enums.shares.status"),
            patch("maelstrom.enums.shares.output"),
        ):
...
"""
    ...
    def test_json_output_with_local_groups_filter(self):
        ...
        with (
            patch("maelstrom.enums.local_groups.run_nxc") as mock_run_nxc,
            patch("maelstrom.enums.local_groups.print_section"),
            patch("maelstrom.enums.local_groups.status"),
            patch("maelstrom.enums.local_groups.output"),
        ):
...
class TestParseInfoLines(unittest.TestCase):
    ...
    def test_parse_disabled_status(self):
        ...
        from maelstrom.enums.users import parse_info_lines
...
class TestVerboseShareInfo(unittest.TestCase):
    ...
    def test_parse_share_check(self):
        ...
        from maelstrom.enums.shares import parse_verbose_share_info
